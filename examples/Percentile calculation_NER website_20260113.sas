...
*Define Age Groups;
  ...
  if ridageyr ge  1 and ridageyr le  5 then age_grp = 1;
  if ridageyr ge  6 and ridageyr le 11 then age_grp = 2;
  if ridageyr ge 12 and ridageyr le 19 then age_grp = 3;
  if ridageyr ge 20 then age_grp = 4;
  if ridageyr ge  1 then age_group = 1;
...
data fin&var5;
    ...
    if "&var1" eq 'age_grp' and &var2 eq 1 then Population_Group = "Age:   1-5";
    if "&var1" eq 'age_grp' and &var2 eq 2 then Population_Group = "Age:  6-11";
	if "&var1" eq 'age_grp' and &var2 eq 3 then Population_Group = "Age: 12-19";
	if "&var1" eq 'age_grp' and &var2 eq 4 then Population_Group = "Age: 20+  ";
...
%pcntci (age_grp, 4, 8, 95, 4, lbxthg, wtsh2yr);
%pcntci (age_group, 1, 8, 95, 5, lbxthg, wtsh2yr);

%pcntci (sex, 1, 8, 95, 6, lbxthg, wtsh2yr);
%pcntci (sex, 2, 8, 95, 7, lbxthg, wtsh2yr);

%pcntci (race, 1, 8, 95, 8, lbxthg, wtsh2yr);
%pcntci (race, 2, 8, 95, 9, lbxthg, wtsh2yr);
%pcntci (race, 3, 8, 95, 10, lbxthg, wtsh2yr);
%pcntci (race, 4, 8, 95, 11, lbxthg, wtsh2yr);
%pcntci (racial, 1, 8, 95, 12, lbxthg, wtsh2yr);
